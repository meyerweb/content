...
<p class="summary"><span class="seoSummary">The <strong><code>toLocaleString()</code></strong> method returns a human-readable, language-sensitive representation of the <code>{{jsxref('Temporal.PlainDate','Temporal.PlainDate')}}</code> value.</span> This method overrides {{jsxref('Object/toLocaleString','Object.prototype.toLocaleString()')}}.</p>
...
- `options` {{optional_inline}}
  - : An object with some or all of the following properties:
    ...
    "<code>America/New_York</code>".<div class="note">Unlike in <code>{{jsxref('Temporal.Instant/toLocaleString','Temporal.Instant.toLocaleString()')}}</code>, the <code>timeZone</code> property has no effect, because <code>{{jsxref('Temporal.PlainDate','Temporal.PlainDate')}}</code> carries no time zone information and is just a date.</div></dd><dt><code>hour12</code></dt><dd>Whether to use 12-hour time (as opposed to 24-hour time). Possible values
