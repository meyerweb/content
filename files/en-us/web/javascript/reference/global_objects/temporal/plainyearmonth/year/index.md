...
<p class="summary"><span class="seoSummary">The <strong><code>year</code></strong> read-only property returns a number that identifies the year in which the month occurs.</span></p>
