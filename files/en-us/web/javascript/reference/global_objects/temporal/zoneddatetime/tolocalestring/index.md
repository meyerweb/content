  ...
  - : An object with some or all of the following properties:
    ...
    - `timeZone`
      - : The time zone to use. The only value implementations must recognize is
        ...
        > **Warning:** `timeZone` will be automatically set from the time zone
        > of the `zonedDateTime` object. If a different time zone ID is provided
        > in the `timeZone` option, a `RangeError` will be thrown. To display a
        > {{jsxref('Temporal.ZonedDateTime','Temporal.ZonedDateTime')}}
        > value in a different time zone, use
        > `{{jsxref('Temporal.ZonedDateTime/withTimeZone','Temporal.ZonedDateTime.withTimeZone(<var>otherTimeZone</var>)')}}.toLocaleString()`.
    - `hour12`
